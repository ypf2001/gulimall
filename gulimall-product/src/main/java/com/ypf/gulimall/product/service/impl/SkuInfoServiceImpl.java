...
import com.ypf.gulimall.product.service.*;
...
import com.ypf.gulimall.product.dao.SkuInfoDao;
...
public class SkuInfoServiceImpl extends ServiceImpl<SkuInfoDao, SkuInfoEntity> implements SkuInfoService {
    ...
    public SkuItemVo item(Long skuId) throws ExecutionException, InterruptedException {
        ...
        CompletableFuture<Void> baseAttrFuture = infoFuture.thenAcceptAsync(res -> {
            ...
            skuItemVo.setAttrGroup(attrGroupVos);
        ...
        CompletableFuture.allOf(descFuture,imageFuture,baseAttrFuture,saleAttrFuture).get();
